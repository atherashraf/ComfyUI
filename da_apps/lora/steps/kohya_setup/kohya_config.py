...
#     """
#     Generates TOML config for SDXL training (Low VRAM Mode).
#     """
#
...
#             "network_dim": 64,
#             "network_alpha": 32,
#             # !!! FIX: Train ONLY the image part (UNet), not the text part
...
#         },
#         "sdxl_arguments": {
#             # !!! FIX: Cache text outputs since we aren't training them
